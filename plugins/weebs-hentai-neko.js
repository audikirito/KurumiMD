...
let animebooty = (ch == true ? false : false)
...
const sections = [
   {
	...
	{title: `${ animebooty == true ? p:f}` + "A • AnimeBooty", rowId: ".nsfw animebooty"},
	{title: `${ animetiddies== true ? p:f}` + "A • AnimeTiddies", rowId: ".nsfw animetiddies"},
	{title: `${ ass == true ? p:f}` + "A • Ass", rowId: ".nsfw ass"},
	{title: `${ blowjob == true ? p:f}` + "B • BlowJob", rowId: ".nsfw blowjob"},
	{title: `${ cums == true ? p:f}` + "C • Cums", rowId: ".nsfw cums"},
	...
	{title: `${ feetg == true ? p:f}` + "F • Feetg", rowId: ".nsfw feetg"},
	...
	{title: `${ armpit == true ? p:f}` + "J • Jahy", rowId: ".nsfw jahy"},
...
case 'ass':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'ass' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'eroyuri':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(resl + 'eroyuri' + apil)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
...
case 'girlsolo':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(resl + 'solog' + apil)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
